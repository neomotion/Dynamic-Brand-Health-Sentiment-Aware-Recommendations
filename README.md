...
Slope Value              Trend          Status,Description
Slope > 0.5              Upward         The brand is gaining momentum; sentiment and ratings are improving over time.
Slope < -0.5             Downward       The brand is losing favor; scores are consistently dropping, indicating potential quality issues.
-0.5 ≤ Slope ≤ 0.5       Stable         The brand maintains a consistent health score with no significant change in momentum.
